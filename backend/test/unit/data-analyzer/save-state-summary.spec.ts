...
import { saveStateSummary } from "../../../src/data-analyzer/services/save-state-summary";

describe("saveStateSummary", () => {
  ...
  it("should call saveVoteAnalysis with the correct params", async () => {
    ...
    await saveStateSummary("CO", mockRawVote, mockRepo);
    ...
    expect(saveVoteAnalysisStub.args[0][0].sort).to.equal("state-CO");
  });
});
