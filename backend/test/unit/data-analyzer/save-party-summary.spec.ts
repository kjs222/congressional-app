...
import { savePartySummary } from "../../../src/data-analyzer/services/save-party-summary";

describe("savePartySummary", () => {
  ...
  it("should call saveVoteAnalysis with the correct params", async () => {
    ...
    await savePartySummary("democratic", mockRawVote, mockRepo);
    ...
    expect(saveVoteAnalysisStub.args[0][0].sort).to.equal("party-democratic");
  });
});
